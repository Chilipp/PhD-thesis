...
\examiner{Prof. Dr. Christian Kull (\textit{president}), Prof. Dr. Grégoire Mariéthoz~(\textit{director}),\\Basil A. S. Davis~(\textit{co-director}),Prof. Dr. John Robert Tipton~(\textit{examiner}), \\Prof. Dr. Christoph Cornelius Raible~(\textit{examiner})} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
...
\faculty{\href{https://www.unil.ch/gse}{Faculty of Geosciences and Environment (GSE)}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
\includeonly{Chapters/straditize}
...
\href{https://www.unil.ch}{\includegraphics{unilogo_noir.pdf}} \\[0.25cm] % University/department logo - uncomment to place it
...
\begin{refsection}
	\blockquote{
		\textit{Please cite the original publication by \cite{SommerRechChevalierEtAl2019}}
		\bibforkey{SommerRechChevalierEtAl2019}
		\textit{when citing this chapter as \cite{Sommer2020d}}
		\bibforkey{Sommer2020d}
	}
\end{refsection}
